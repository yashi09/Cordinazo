...
<title>Guest Lecture home</title>
...
<body>
	<f:view>
			...
			<div class="container" style="padding-top: 15px;">
				<h:form>
					<h:panelGrid columns="4">
						<c:forEach items="#{guestLecturesHome.guestLectures}" var="guestLecture">
							<h:column>
								<div class="col-sm-12">
									<div class="thumbnail">
										<h:graphicImage id="image" alt="200x200"
											...
											value="../images/#{guestLecture.eventName}.jpg">
										</h:graphicImage>
											<div class="caption">
											<h3>
											...
											<p>
												<h:outputText value="#{guestLecture.startDate} to #{guestLecture.endDate}"></h:outputText>
											</p>
											<p>
												<h:outputText value="#{guestLecture.eventDescription}"></h:outputText>
											</p>
											<h:commandLink styleClass="btn secondary-button"
												action="#{guestLecturesHome.navNext}">
												More details &raquo;
												<f:setPropertyActionListener value="guestLecturePage"
													target="#{guestLecturesHome.action}" />
												<f:setPropertyActionListener value="#{guestLecture.eventId}"
													target="#{guestLecturesHome.guestLectureId}" />
											</h:commandLink>
										</div>
									</div>
								</div>
		...
		<t:saveState value="#{guestLecturesHome.guestLectures}"></t:saveState>
</f:view>
