...
<title>View Coords Of Event</title>
...
<body>
	<f:view>
		...
		<div>
			<c:forEach items="#{viewCoordsOfEvent.coordinators}" var="coordinator">
				<div class="panel panel-default">
					<div class="panel-body">
						<h4><h:outputText value="#{coordinator.firstName} #{coordinator.lastName}"></h:outputText></h4>
						<h:outputText value="#{coordinator.phoneNo}"></h:outputText><br>
